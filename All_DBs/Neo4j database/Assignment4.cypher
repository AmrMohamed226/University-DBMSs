...
RETURN TA,T,CI;
// Query 3
MATCH (CI:Course_Instance{,studyPeriod:'1.0',academicYearCourIn:"2018-2019"})-[:instanceOf]-(C:Course {courseCode:'1011'})
MATCH (T:Teacher)-[a:assignedHours]-(CI)
WHERE a.hours>120 
RETURN DISTINCT T,CI,C;
// Query 4
